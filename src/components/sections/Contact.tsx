...
const Contact: React.FC = () => {
  return (
    <section id="contact" className="py-20 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="relative">
            <div className="bg-white dark:bg-zinc-800 rounded-xl shadow-xl p-8 border border-zinc-200 dark:border-zinc-700 hover-lift">
              ...
              <form
                className="space-y-5"
                action="https://formsubmit.co/sobiagerdazi2014@gmail.com"
                method="POST"
              >
      ...
      <div
        className="absolute right-0 bottom-0 -z-10 transform translate-x-1/3 translate-y-1/4 opacity-10 dark:opacity-5"
        aria-hidden="true"
      >
        <div className="w-64 h-64 rounded-full bg-gradient-to-br from-blue-500 to-purple-500 blur-3xl"></div>
      </div>
      <div
        className="absolute left-0 top-1/4 -z-10 transform -translate-x-1/3 opacity-10 dark:opacity-5"
        aria-hidden="true"
      >
